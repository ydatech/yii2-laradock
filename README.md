...
## docker-compose.yml
- We added new argument to docker-compose.yml for php-fpm container called INSTALL_INTL. We will use this argument
...
## php-fpm container
- We added some code to install php Internationalization support on php-fpm Dockerfile
- We added new file called yii.ini under the php-fpm folder
- We added a line of Dockerfile syntax to add yii.ini config to php default config on fphp-fpm Dockerfile
